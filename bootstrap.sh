...
g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c src/busy/busy.cpp -o obj/src/busy/busy.o  -I src/busy -I src  -isystem src -isystem src -isystem src -isystem external/SelfTest/external/Process/src -isystem external/sargparse/src -isystem external/yaml-cpp/src -isystem external/yaml-cpp/src
mkdir -p obj/src/busy
g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c src/busy/Project.cpp -o obj/src/busy/Project.o  -I src/busy -I src  -isystem src -isystem src -isystem src -isystem external/SelfTest/external/Process/src -isystem external/sargparse/src -isystem external/yaml-cpp/src -isystem external/yaml-cpp/src
mkdir -p obj/src/busy
g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c src/busy/cache.cpp -o obj/src/busy/cache.o  -I src/busy -I src  -isystem src -isystem src -isystem src -isystem external/SelfTest/external/Process/src -isystem external/sargparse/src -isystem external/yaml-cpp/src -isystem external/yaml-cpp/src
mkdir -p obj/src/busy
g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c src/busy/File.cpp -o obj/src/busy/File.o  -I src/busy -I src  -isystem src -isystem src -isystem src -isystem external/SelfTest/external/Process/src -isystem external/sargparse/src -isystem external/yaml-cpp/src -isystem external/yaml-cpp/src
mkdir -p obj/src/busy
g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c src/busy/toolchains.cpp -o obj/src/busy/toolchains.o  -I src/busy -I src  -isystem src -isystem src -isystem src -isystem external/SelfTest/external/Process/src -isystem external/sargparse/src -isystem external/yaml-cpp/src -isystem external/yaml-cpp/src
mkdir -p obj/src/busy
g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c src/busy/FileCache.cpp -o obj/src/busy/FileCache.o  -I src/busy -I src  -isystem src -isystem src -isystem src -isystem external/SelfTest/external/Process/src -isystem external/sargparse/src -isystem external/yaml-cpp/src -isystem external/yaml-cpp/src
...
mkdir -p obj/src/busy
g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c src/busy/Package.cpp -o obj/src/busy/Package.o  -I src/busy -I src  -isystem src -isystem src -isystem src -isystem external/SelfTest/external/Process/src -isystem external/sargparse/src -isystem external/yaml-cpp/src -isystem external/yaml-cpp/src
mkdir -p obj/src/busy
