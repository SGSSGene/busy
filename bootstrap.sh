...
setupSystemIncludesPaths .. src/busy src/base64 src/fon src/picosha2 external/sargparse/src/sargparse external/yaml-cpp/src/yaml-cpp external/fmt/src/fmt external/fmt/include/fmt external/SelfTest/external/Process/src/process external/yaml-cpp/src/yaml-cpp
setupTranslationSet src/demangle
setupTranslationSet external/sargparse/src/exampleSargparse
setupSystemIncludesPaths .. external/sargparse/src/exampleSargparse external/sargparse/src/sargparse
setupTranslationSet external/fmt/src/fmt
setupTranslationSet src/fon
setupSystemIncludesPaths .. src/fon external/yaml-cpp/src/yaml-cpp
...
setupSystemIncludesPaths .. external/SelfTest/src/selfTest external/SelfTest/external/Process/src/process
setupTranslationSet src/testBase64
setupSystemIncludesPaths .. src/testBase64 src/base64
setupTranslationSet external/SelfTest/external/Process/src/testProcess
setupSystemIncludesPaths .. external/SelfTest/external/Process/src/testProcess external/SelfTest/external/Process/src/process
setupTranslationSet external/SelfTest/src/testSelfTest
setupSystemIncludesPaths .. external/SelfTest/src/testSelfTest external/SelfTest/src/selfTest external/SelfTest/external/Process/src/process
setupTranslationSet external/ThreadPool/src/testThreadPool
setupSystemIncludesPaths .. external/ThreadPool/src/testThreadPool external/gtest/src/gtest external/gtest/include/gtest external/ThreadPool/src/threadPool
setupTranslationSet external/yaml-cpp/src/testsYaml
setupSystemIncludesPaths .. external/yaml-cpp/src/testsYaml external/yaml-cpp/src/yaml-cpp
...
# compile external/gtest/src/gtest
    ...
    g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c external/gtest/src/gtest/src/gtest-port.cc -o obj/external/gtest/src/gtest/src/gtest-port.o  -iquote external/gtest/src/gtest -iquote external/gtest/include -iquote external/gtest  $systemIncludes
# compile external/gtest/src/gtest
    systemIncludes="$(setupSystemIncludes "external/gtest/src/gtest")"
    mkdir -p obj/external/gtest/src/gtest/src
    g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c external/gtest/src/gtest/src/gtest-typed-test.cc -o obj/external/gtest/src/gtest/src/gtest-typed-test.o  -iquote external/gtest/src/gtest -iquote external/gtest/include -iquote external/gtest  $systemIncludes
# compile external/gtest/src/gtest
    systemIncludes="$(setupSystemIncludes "external/gtest/src/gtest")"
    mkdir -p obj/external/gtest/src/gtest/src
    g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c external/gtest/src/gtest/src/gtest_main.cpp -o obj/external/gtest/src/gtest/src/gtest_main.o  -iquote external/gtest/src/gtest -iquote external/gtest/include -iquote external/gtest  $systemIncludes
# compile external/gtest/src/gtest
    systemIncludes="$(setupSystemIncludes "external/gtest/src/gtest")"
    mkdir -p obj/external/gtest/src/gtest/src
    g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c external/gtest/src/gtest/src/gtest-test-part.cc -o obj/external/gtest/src/gtest/src/gtest-test-part.o  -iquote external/gtest/src/gtest -iquote external/gtest/include -iquote external/gtest  $systemIncludes
# compile external/gtest/src/gtest
    systemIncludes="$(setupSystemIncludes "external/gtest/src/gtest")"
    mkdir -p obj/external/gtest/src/gtest/src
    g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c external/gtest/src/gtest/src/gtest-printers.cc -o obj/external/gtest/src/gtest/src/gtest-printers.o  -iquote external/gtest/src/gtest -iquote external/gtest/include -iquote external/gtest  $systemIncludes
# compile external/gtest/src/gtest
    systemIncludes="$(setupSystemIncludes "external/gtest/src/gtest")"
    mkdir -p obj/external/gtest/src/gtest/src
    g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c external/gtest/src/gtest/src/gtest.cc -o obj/external/gtest/src/gtest/src/gtest.o  -iquote external/gtest/src/gtest -iquote external/gtest/include -iquote external/gtest  $systemIncludes
# compile external/gtest/src/gtest
    systemIncludes="$(setupSystemIncludes "external/gtest/src/gtest")"
    mkdir -p obj/external/gtest/src/gtest/src
    g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c external/gtest/src/gtest/src/gtest-filepath.cc -o obj/external/gtest/src/gtest/src/gtest-filepath.o  -iquote external/gtest/src/gtest -iquote external/gtest/include -iquote external/gtest  $systemIncludes
# compile external/gtest/src/gtest
    systemIncludes="$(setupSystemIncludes "external/gtest/src/gtest")"
    mkdir -p obj/external/gtest/src/gtest/src
    g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c external/gtest/src/gtest/src/gtest-death-test.cc -o obj/external/gtest/src/gtest/src/gtest-death-test.o  -iquote external/gtest/src/gtest -iquote external/gtest/include -iquote external/gtest  $systemIncludes
...
# compile external/fmt/src/fmt
    ...
    g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c external/fmt/src/fmt/os.cc -o obj/external/fmt/src/fmt/os.o  -iquote external/fmt/src/fmt -iquote external/fmt/include -iquote external/fmt  $systemIncludes
# compile external/fmt/src/fmt
    systemIncludes="$(setupSystemIncludes "external/fmt/src/fmt")"
    mkdir -p obj/external/fmt/src/fmt
    g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c external/fmt/src/fmt/format.cc -o obj/external/fmt/src/fmt/format.o  -iquote external/fmt/src/fmt -iquote external/fmt/include -iquote external/fmt  $systemIncludes
...
# linking bin/busy as executable
    mkdir -p bin
    g++ -rdynamic -g3 -ggdb -fdiagnostics-color=always -o bin/busy obj/src/busy/busy.o obj/src/busy/FileCache.o obj/src/busy/toolchains.o obj/src/busy/cache.o obj/src/busy/completion.o obj/src/busy/utils.o obj/src/busy/cmd/clean.o obj/src/busy/cmd/lsToolchains.o obj/src/busy/cmd/version.o obj/src/busy/cmd/status.o obj/src/busy/cmd/compile.o obj/src/busy/cmd/showDeps.o obj/src/busy/CompilePipe.o obj/src/busy/File.o obj/src/busy/ConsolePrinter.o obj/src/busy/analyse.o obj/src/busy/TranslationSet.o obj/src/busy/Package.o lib/base64.a lib/sargparse.a lib/yaml-cpp.a lib/fmt.a lib/process.a lib/yaml-cpp.a -lstdc++fs -lpthread
