...
g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c src/busy/utils.cpp -o obj/src/busy/utils.o  -I src/busy -I src  -isystem src -isystem external/SelfTest/external/Process/src -isystem external/sargparse/src -isystem external/yaml-cpp/src
g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c src/busy/busy.cpp -o obj/src/busy/busy.o  -I src/busy -I src  -isystem src -isystem external/SelfTest/external/Process/src -isystem external/sargparse/src -isystem external/yaml-cpp/src
g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c src/busy/ConsolePrinter.cpp -o obj/src/busy/ConsolePrinter.o  -I src/busy -I src  -isystem src -isystem external/SelfTest/external/Process/src -isystem external/sargparse/src -isystem external/yaml-cpp/src
g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c src/busy/analyse.cpp -o obj/src/busy/analyse.o  -I src/busy -I src  -isystem src -isystem external/SelfTest/external/Process/src -isystem external/sargparse/src -isystem external/yaml-cpp/src
g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c src/busy/Project.cpp -o obj/src/busy/Project.o  -I src/busy -I src  -isystem src -isystem external/SelfTest/external/Process/src -isystem external/sargparse/src -isystem external/yaml-cpp/src
g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c src/busy/cache.cpp -o obj/src/busy/cache.o  -I src/busy -I src  -isystem src -isystem external/SelfTest/external/Process/src -isystem external/sargparse/src -isystem external/yaml-cpp/src
g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c src/busy/File.cpp -o obj/src/busy/File.o  -I src/busy -I src  -isystem src -isystem external/SelfTest/external/Process/src -isystem external/sargparse/src -isystem external/yaml-cpp/src
g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c src/busy/toolchains.cpp -o obj/src/busy/toolchains.o  -I src/busy -I src  -isystem src -isystem external/SelfTest/external/Process/src -isystem external/sargparse/src -isystem external/yaml-cpp/src
g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c src/busy/FileCache.cpp -o obj/src/busy/FileCache.o  -I src/busy -I src  -isystem src -isystem external/SelfTest/external/Process/src -isystem external/sargparse/src -isystem external/yaml-cpp/src
mkdir -p obj/src/busy/utils
g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c src/busy/utils/utils.cpp -o obj/src/busy/utils/utils.o  -I src/busy -I src  -isystem src -isystem external/SelfTest/external/Process/src -isystem external/sargparse/src -isystem external/yaml-cpp/src
mkdir -p obj/src/busy
g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c src/busy/Package.cpp -o obj/src/busy/Package.o  -I src/busy -I src  -isystem src -isystem external/SelfTest/external/Process/src -isystem external/sargparse/src -isystem external/yaml-cpp/src
g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c src/busy/CompilePipe.cpp -o obj/src/busy/CompilePipe.o  -I src/busy -I src  -isystem src -isystem external/SelfTest/external/Process/src -isystem external/sargparse/src -isystem external/yaml-cpp/src
...
g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c external/ThreadPool/external/gtest/src/gtest/src/gtest-all.cpp -o obj/external/ThreadPool/external/gtest/src/gtest/src/gtest-all.o  -I external/ThreadPool/external/gtest/src/gtest -I external/ThreadPool/external/gtest/include -I external/ThreadPool/external/gtest
...
g++ -O0 -std=c++20 -fPIC -MD -g3 -ggdb -fdiagnostics-color=always -c external/gtest/src/gtest/src/gtest-all.cpp -o obj/external/gtest/src/gtest/src/gtest-all.o  -I external/gtest/src/gtest -I external/gtest/include -I external/gtest
...
ld -Ur -o lib/gtest.a.o obj/external/ThreadPool/external/gtest/src/gtest/src/gtest_main.o obj/external/ThreadPool/external/gtest/src/gtest/src/gtest-all.o && ar rcs lib/gtest.a lib/gtest.a.o
ld -Ur -o lib/process.a.o obj/external/SelfTest/external/Process/src/process/InteractiveProcess.o obj/external/SelfTest/external/Process/src/process/Process.o && ar rcs lib/process.a lib/process.a.o
ld -Ur -o lib/sargparse.a.o obj/external/sargparse/src/sargparse/ArgumentParsing.o obj/external/sargparse/src/sargparse/man.o obj/external/sargparse/src/sargparse/Parameter.o && ar rcs lib/sargparse.a lib/sargparse.a.o
ld -Ur -o lib/gtest.a.o obj/external/gtest/src/gtest/src/gtest_main.o obj/external/gtest/src/gtest/src/gtest-all.o && ar rcs lib/gtest.a lib/gtest.a.o
...
g++ -rdynamic -g3 -ggdb -fdiagnostics-color=always -o bin/testThreadPool obj/external/ThreadPool/src/testThreadPool/testThreadPool.o lib/gtest.a lib/gtest.a -lpthread
...
g++ -rdynamic -g3 -ggdb -fdiagnostics-color=always -o bin/busy obj/src/busy/utils.o obj/src/busy/busy.o obj/src/busy/ConsolePrinter.o obj/src/busy/analyse.o obj/src/busy/Project.o obj/src/busy/cache.o obj/src/busy/File.o obj/src/busy/toolchains.o obj/src/busy/FileCache.o obj/src/busy/utils/utils.o obj/src/busy/Package.o obj/src/busy/CompilePipe.o lib/base64.a lib/process.a lib/sargparse.a lib/yaml-cpp.a lib/yaml-cpp.a -lstdc++fs -lpthread
